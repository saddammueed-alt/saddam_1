...
if tab == "🏠 Home":
    ...
    - **Delivery Routes** (Travelling Salesman Problem)
    - **Shelf Space Allocation** (K-Means Clustering)
...
# ------------------------------------------------
    ...
    # Warehouse & Customers Coordinates
    locations = {
        "Warehouse": (0, 0),
        "Customer A": (2, 4),
        "Customer B": (5, 2),
...
# ------------------------------------------------
    ...
    fig3 = px.bar(
        df_inv, x="Product_Name", y="Quantity",
        color="Status", title="Stock Level per Product", text="Quantity"
    )
